...
public class configDB {
    /* 
        RENCANA METHOD(PROCEDURE/FUNCTION)
        SIMPAN, UBAH, HAPUS, CARI DATA, DUPLIKAT DATA
        TAMPIL DATA, CETAK LAPORAN
    */
    private String jdbcUrl ="jdbc:mysql://localhost:3306/2210010052_pbo2";
    ...
    public configDB(){}
        ...
        try {
            ...
            if(baris==0){hasil=false;}else{hasil=true;}
